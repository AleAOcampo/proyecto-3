...
{
  size(1000,1000);
  startfinal = loadImage("llamas.jpg");
  james = new fluffies(10, 2, "james", 1);
  george = new fluffies(8, 1, "george", 2);
  gossamer = new fluffies(12, 2, "gossamer", 3);
  eduardo = new fluffies(10, 1, "eduardo", 4);
  yeti = new fluffies(9, 1, "yeti", 5);
  bates = new fluffies(11, 3, "bates", 6);
}
...
{ 
  ...
  switch(screen)
  {
    case 0: 
    background(0);
    image(startfinal,0,250);
    startfinal.resize(0,500);
    textSize(100);
    fill(255,0,0);
    text("Fluffy Demons", 150,350);
    textSize(40);
    fill(227);
    text("click para continuar", 300, 450);
...
background(127);
 ...
 //seleccion jugador 2
  pushMatrix();
    ...
    fill(255);
    textSize(15);
    text("Presiona 1 para seleccionar a Bates", 42, 700);
    if(keyPressed){
    if(key == '1'){
      jugador2 = bates.number;
      player_b=bates;
      screen=3;
    }
  }
    ...
    fill(255);
    textSize(15);
    text("Presiona 2 para seleccionar a Eduardo", 370, 700);
    if(keyPressed){
    if(key == '2'){
      jugador2 = eduardo.number;
      player_b=eduardo;
      screen=3;
    }
  }
    ...
    fill(255);
    textSize(15);
    text("Presiona 3 para seleccionar al Yeti", 700, 600);
    if(keyPressed){
    if(key == '3'){
      jugador2 = yeti.number;
      player_b=yeti;
      screen=3;
    }
  }
    ...
    fill(255);
    textSize(15);
    text("Presiona 4 para seleccionar a George", 42, 600);
    if(keyPressed){
    if(key == '4'){
      jugador2 = george.number;
      player_b=george;
      screen=3;
    }
  }
    ...
    fill(255);
    textSize(15);
    text("Presiona 5 para seleccionar a Gossamer", 700, 700);
    if(keyPressed){
    if(key == '5'){
      jugador2 = gossamer.number;
      player_b=gossamer;
      screen=3;
    }
  }
    ...
    fill(255);
    textSize(15);
    text("Presiona 6 para seleccionar a Sullivan", 370, 600);
    if(keyPressed){
    if(key == '6'){
      jugador2 = james.number;
      player_b=james;
      screen=3;
    }
  }
...
if(player_b==yeti){
  ...
  if(keyPressed){
    if(key == 'a'){
      player_a.HP = player_a.HP - player_b.attack;
      turno = 1;
    }
   ...
   fill(0);
   rect(200,550,player_a.HP*5,50);
  }
  
  if(turno == 1){
    if(keyPressed){
      if(key == 'b'){
        player_b.HP = player_b.HP - player_a.attack;
        turno = 0;
      }
  ...
  fill(255);
  textSize(20);
  text("Presiona r para jugar otra vez... ya!!", 350,470);
  if(keyPressed){
    if(key == 'r'){
      turno = 0;
      screen = 0;
